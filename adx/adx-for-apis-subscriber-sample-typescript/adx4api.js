...
function makeAdxForApiSubscriberCall(sendApiAssetCommandInput) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            const sendApiAssetCommandOutput = yield dataExchangeClient.send(sendApiAssetCommand);
            console.log("Output");
...
(() => __awaiter(void 0, void 0, void 0, function* () {
    yield makeAdxForApiSubscriberCall(sendApiAssetCommandInput);
}))();
