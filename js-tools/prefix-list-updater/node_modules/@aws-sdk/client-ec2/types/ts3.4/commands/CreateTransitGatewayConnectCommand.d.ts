...
export declare type CreateTransitGatewayConnectCommandInput = CreateTransitGatewayConnectRequest;
export declare type CreateTransitGatewayConnectCommandOutput = CreateTransitGatewayConnectResult & __MetadataBearer;
/**
