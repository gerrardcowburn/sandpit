...
export declare type GetGroupsForCapacityReservationCommandInput = GetGroupsForCapacityReservationRequest;
export declare type GetGroupsForCapacityReservationCommandOutput = GetGroupsForCapacityReservationResult & __MetadataBearer;
/**
