...
export declare type ModifyVpnConnectionOptionsCommandInput = ModifyVpnConnectionOptionsRequest;
export declare type ModifyVpnConnectionOptionsCommandOutput = ModifyVpnConnectionOptionsResult & __MetadataBearer;
/**
