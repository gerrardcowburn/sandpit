...
export declare type CreateCarrierGatewayCommandInput = CreateCarrierGatewayRequest;
export declare type CreateCarrierGatewayCommandOutput = CreateCarrierGatewayResult & __MetadataBearer;
/**
