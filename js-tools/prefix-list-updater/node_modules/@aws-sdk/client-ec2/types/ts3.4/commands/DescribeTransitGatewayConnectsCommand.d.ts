...
export declare type DescribeTransitGatewayConnectsCommandInput = DescribeTransitGatewayConnectsRequest;
export declare type DescribeTransitGatewayConnectsCommandOutput = DescribeTransitGatewayConnectsResult & __MetadataBearer;
/**
