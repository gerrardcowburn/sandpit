...
export declare type DeleteCarrierGatewayCommandInput = DeleteCarrierGatewayRequest;
export declare type DeleteCarrierGatewayCommandOutput = DeleteCarrierGatewayResult & __MetadataBearer;
/**
