...
export declare type GetManagedPrefixListEntriesCommandInput = GetManagedPrefixListEntriesRequest;
export declare type GetManagedPrefixListEntriesCommandOutput = GetManagedPrefixListEntriesResult & __MetadataBearer;
/**
