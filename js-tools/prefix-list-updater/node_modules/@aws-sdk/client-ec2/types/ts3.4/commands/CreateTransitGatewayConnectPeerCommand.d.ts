...
export declare type CreateTransitGatewayConnectPeerCommandInput = CreateTransitGatewayConnectPeerRequest;
export declare type CreateTransitGatewayConnectPeerCommandOutput = CreateTransitGatewayConnectPeerResult & __MetadataBearer;
/**
