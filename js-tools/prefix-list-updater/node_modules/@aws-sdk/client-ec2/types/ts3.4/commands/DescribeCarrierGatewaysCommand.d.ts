...
export declare type DescribeCarrierGatewaysCommandInput = DescribeCarrierGatewaysRequest;
export declare type DescribeCarrierGatewaysCommandOutput = DescribeCarrierGatewaysResult & __MetadataBearer;
/**
