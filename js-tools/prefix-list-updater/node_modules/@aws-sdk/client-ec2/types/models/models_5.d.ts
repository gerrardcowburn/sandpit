import { BlockDeviceMapping, ByoipCidr, CreditSpecificationRequest, ElasticGpuSpecification, IamInstanceProfileSpecification, InstanceInterruptionBehavior, IpPermission, MarketType, Placement, ShutdownBehavior, SpotInstanceType, TagSpecification, TransitGatewayAttachmentResourceType, _InstanceType } from "./models_0";
import { InstanceIpv6Address, LocalGatewayRoute, TransitGatewayRoute } from "./models_1";
import { ClientVpnConnectionStatus, Filter, HttpTokensState, InstanceMetadataEndpointState, InstanceState } from "./models_2";
import { InstanceNetworkInterfaceSpecification, NetworkInsightsAnalysis, RunInstancesMonitoringEnabled } from "./models_3";
import { CapacityReservationSpecification, CpuOptionsRequest, ElasticInferenceAccelerator, EnclaveOptionsRequest, InstanceMonitoring } from "./models_4";
/**
