import { ActiveInstance, ActivityStatus, AllocationStrategy, AllowedPrincipal, AlternatePathHint, AssociationStatus, AttributeValue, BatchState, BlockDeviceMapping, CurrencyCodeValues, FleetLaunchTemplateSpecification, FleetType, IamInstanceProfileAssociation, IamInstanceProfileSpecification, InstanceInterruptionBehavior, InternetGateway, IpPermission, ReservedInstancesListing, ResourceType, SpotInstanceType, Subnet, SubnetIpv6CidrBlockAssociation, Tag, TagSpecification, Tenancy, TransitGatewayAssociationState, TransitGatewayAttachmentResourceType, TransitGatewayAttachmentState, TransitGatewayMulticastDomainAssociations, TransitGatewayPeeringAttachment, TransitGatewayVpcAttachment, UserIdGroupPair, VolumeType, Vpc, VpcPeeringConnection, _InstanceType } from "./models_0";
import { ConnectionNotification, DnsEntry, DnsNameState, GroupIdentifier, InstanceIpv6Address, LaunchTemplate, LaunchTemplateVersion, LocalGatewayRouteTableVpcAssociation, ManagedPrefixList, NatGateway, NetworkAcl, NetworkInsightsPath, NetworkInterface, NetworkInterfaceAttachment, NetworkInterfacePermission, PlacementGroup, PortRange, PrivateIpAddressSpecification, RouteTable, ServiceConfiguration, ServiceTypeDetail, Snapshot, SpotDatafeedSubscription, SpotInstanceStateFault, State, TrafficMirrorFilter, TrafficMirrorSession, TrafficMirrorTarget, TransitGateway, TransitGatewayConnect, TransitGatewayConnectPeer, TransitGatewayMulticastDomain, TransitGatewayRouteTable, Volume, VpcEndpoint, VpnConnection, VpnGateway } from "./models_1";
import { AttributeBooleanValue, EbsInfo, EventInformation, FastSnapshotRestoreStateCode, Filter, FpgaInfo, GpuInfo, IdFormat, InstanceTypeHypervisor, PermissionGroup, ProductCode, VirtualizationType } from "./models_2";
/**
